...
void loop() {
  ...
  colorWipe(strip.Color(255,   102,   0), 50); 
  colorWipe(strip.Color(255,   0,   102), 50); 
  colorWipe(strip.Color(102,   0,   0), 50); 
  colorWipe(strip.Color(0,   102,   102), 50); 


  colorWipe2(strip2.Color(0,   0,   255), 50); 
  colorWipe2(strip2.Color(255,   102,   0), 50); 
  colorWipe2(strip2.Color(255,   0,   102), 50); 
  colorWipe2(strip2.Color(102,   0,   0), 50); 
  colorWipe2(strip2.Color(0,   102,   102), 50); 


 colorWipe3(strip3.Color(0,   0,   255), 50); 
  colorWipe3(strip3.Color(255,   102,   0), 50); 
  colorWipe3(strip3.Color(255,   0,   102), 50); 
  colorWipe3(strip3.Color(102,   0,   0), 50); 
  colorWipe3(strip3.Color(0,   102,   102), 50); 
...
void colorWipe3(uint32_t color3, int wait3) {
  for(int i=0; i<strip3.numPixels(); i++) { // For each pixel in strip...
    strip3.setPixelColor(i, color3);         //  Set pixel's color (in RAM)
